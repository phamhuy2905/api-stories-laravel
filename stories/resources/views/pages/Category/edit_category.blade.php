    ...
    <form method="POST" action={{route('category.update')}}>
        ...
        <div class="grid grid-cols-1 gap-4">
            <div class="flex flex-col">
                <label class="text-[16px] text-gray-500 my-4" for="name">Edit category:</label>
                ...
                <button class="bg-blue-500 text-white text-[17px] text-center py-2 rounded-[10px] mt-10">Edit category</button>
            </div>
        </div>
    </form>
@endsection
