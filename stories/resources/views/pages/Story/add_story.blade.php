    ...
    <form method="POST" action={{route('story.store')}} enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 gap-4">
            <div class="flex flex-col">
                ...
                <input class="py-2 px-4 w-full text-[16px] text-gray-500 outline-blue-500 border-[#ddd] border-2" type="text" name="name" id="name" placeholder="Please name publisher..."  value="{{ old('name') }}">
            </div>

            <div class="flex flex-col">
              <label class="text-[16px] text-gray-500 my-4" for="name_author">Name author:</label>
              <input class="py-2 px-4 w-full text-[16px] text-gray-500 outline-blue-500 border-[#ddd] border-2" type="text" name="name_author" id="name_author" placeholder="Please name author..."  value="{{ old('name_author') }}" >
            </div>
          ...
          <div class="flex flex-col">
            ...
            <textarea class="p-2 border-[#ddd] border-2 rounded-[10px] outline-blue-500" name="description_short" id="" cols="30" rows="3"> {{ old('description_short') }}</textarea>
          </div>
          <div class="flex flex-col">
            <label class="text-[16px] text-gray-500 my-4 " for="description_long">Description long:</label>
            <textarea class="p-2 border-[#ddd] border-2 rounded-[10px] outline-blue-500" name="description_long" id="" cols="30" rows="3">{{ old('description_long') }}</textarea>
          </div>
          ...
          <div class="flex flex-col mt-1">
            <img src="{{ url('img/no_img.png') }}" class="rounded mr-75 border-primary show_img" alt="profile image" height="200" width="200" style="object-fit: cover" class="show_img" id="show_img">
          </div>
          ...
          <button class="bg-blue-500 text-white text-[17px] text-center py-2 rounded-[10px] mt-10">Add story</button>
      </div>
    </form>
@endsection
